import { Scene, ParticleSystem, Texture, Color4, Vector3, CubeTexture, DirectionalLight, ParticleHelper, HemisphericLight, CreateSphere, AbstractMesh, MeshBuilder, PointLight, Color3, VolumetricLightScatteringPostProcess, ArcRotateCameraMouseWheelInput, ArcRotateCamera, Mesh, UniformBuffer, UniversalCamera } from "@babylonjs/core";
...
export class WeatherSystem {
  ...
  private emitterSphere: AbstractMesh | null | undefined;
  ...
  private setClearWeather(): void {
    ...
    this.scene.fogDensity = 0.02; // Adjust this value to change fog density
  ...
  private setFoggyWeather(): void {
    ...
    const volumetricFog = new VolumetricLightScatteringPostProcess(
        'volumetric', 1.0, this.camera, null as unknown as Mesh | undefined, 50, Texture.BILINEAR_SAMPLINGMODE
    );
