    ...
    return (
        <section className="about-section" id="about">
            <div className="about-section__left">
                <h4 className="display-2">WHAT IS Dtanks?</h4>
                ...
                <div className="text-container about-text-info">
                    <p>
                    <strong>"Dtanks: Tactical War"</strong> is a cutting-edge web-based strategy game that challenges players to dominate a fictional world through tactical prowess and strategic foresight. Leveraging advanced <em>Babylon.js</em> technology, the game delivers an immersive 3D experience, where every decision impacts the balance of power.
                    </p>
                    <p>
                    ...
                    <p>
                    "Dtanks: Tactical War" not only fosters competitive play but also builds a community of strategists who can share insights, trade assets, and collaborate or compete in ongoing global conflicts.
                    </p>
                </div>
            </div>
