                ...
                <div className="features-accordion">
                    <div className="item-1">
                        ...
                        <div className="features-accordion-content">
                            <p>
                            Dtanks: Tactical War elevates strategic gameplay by combining real-time decision-making with long-term tactical planning. Dominate the battlefield by capturing strategic assets and deploying cunning maneuvers to outwit your opponents.
                            </p>
                        </div>
                    </div>
